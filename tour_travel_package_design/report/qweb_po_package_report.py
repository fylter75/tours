...
class PrintPoQweb(models.AbstractModel):

    _name = 'report.tour_travel_package_design.qweb_po_package_report'
    _description = 'qweb po package report'
    ...
    def _get_report_values(self, docids, data):
        report = self.env['ir.actions.report']._get_report_from_name(
            'tour_travel_package_design.qweb_po_package_report')
