...
class PrintQweb(models.AbstractModel):

    _name = 'report.tour_travel_package_design.qweb_so_package_report'
    _description = 'qweb so package report'
    ...
    def _get_report_values(self, docids, data):
        ...
        report = self.env['ir.actions.report']._get_report_from_name(
            'tour_travel_package_design.qweb_so_package_report')
        so_ids = self.env['sale.order'].browse(docids)
        return {
            'doc_ids': docids,
